...
Romain was right, it is easier with blogdown than it was when hacking html in Jekyll... Enjoy reading, and if you can, attend one of the next satRday conferences, for instance in [Amsterdam on September the 1st](http://amsterdam2018.satrdays.org/)! 

_Note that the options of the chunk below are `r, result = 'asis', comment = NA`, and 35 was determined using `stringi::stri_length('{{< tweet "1009513801333526528" >}}')`._

```{r, result = 'asis', comment = NA}
embed_tweet <- function(tweet_id){
  blogdown::shortcode_html("tweet", tweet_id)
}
library("magrittr")
