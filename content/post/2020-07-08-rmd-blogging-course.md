...
I did that in a physical notebook and then I set up a GitHub repo to use its issue tracker.
...
In two hours, I shared my whole desktop with the attendees[^screen]
