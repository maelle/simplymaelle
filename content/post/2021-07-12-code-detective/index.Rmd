...
Sometimes you'll only notice obvious mistakes after making the problem smaller (or after taking a break!).
...
!!! add something about options and environmental variables !!!
...
* In your IDE e.g. RStudio there might be a way to go directly to the _definition_ of function. With the lookup package you can also easily look up the source of functions [locally and on GitHub](https://blog.r-hub.io/2019/05/14/read-the-source/).
...
It is also a skill: both how and where to ask for help but also deciding when to ask for help, when it's no longer worh anyone's time to have your keeping working alone on a problem.
