...
Sometimes you might also make do with print-debugging i.e. for instance writing `print("coucou !")` to check a part of the code was run, or `print(class(x))` to check an assumption about a thing. 
...
She especially mentions integration tests, whereas in R packages you'll mostly find unit tests.
